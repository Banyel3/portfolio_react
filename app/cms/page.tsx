      ...
      <div className="border-b border-border">
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <Link href="/" className="px-4 py-2 rounded-lg bg-primary text-primary-foreground hover:bg-primary/90">
              View Portfolio
            </Link>
          </div>
        </div>
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-muted-foreground text-sm mb-4">Manage your certifications and credentials</p>
          ...
          >
            ...
            <p className="text-muted-foreground text-sm mb-4">Manage your technical skills</p>
            <div className="text-sm text-primary font-medium">Manage →</div>
          </Link>
        </div>
      </div>
