    ...
    <section id="about" className="py-20 px-6 md:px-12 bg-card">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-4 mb-14 reveal">
          <span className="font-mono text-xs font-semibold text-primary/50 select-none tabular-nums">01</span>
          <h2 className="font-display font-bold text-3xl md:text-4xl text-foreground">About</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          <div className="space-y-6 reveal-left">
            ...
            <a
              ...
              className="group inline-flex items-center gap-2 text-primary font-display font-medium text-lg mt-4"
            >
              cornelio.vaniel38@gmail.com
              <span className="group-hover:-translate-y-0.5 group-hover:translate-x-0.5 transition-transform duration-200">
                ↗
              </span>
            </a>
          </div>
          ...
          <div className="space-y-6 reveal-right" style={{ animationDelay: '0.15s' }}>
            <h3 className="text-3xl md:text-4xl font-display font-bold text-foreground">
            ...
            <div className="pt-4">
              <h4 className="text-xs uppercase tracking-widest text-muted-foreground/70 font-semibold mb-4">
                Core Technologies
              </h4>
              <CoreSkills />
            </div>
